            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-2 pb-2">
                    <h5 class="card-title text-success text-center pb-0 fs-4">Quetta Land Use Dashboard</h5>
                  ...
                  <form class="row g-3 needs-validation" action="fire-login.php" method="POST">
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label text-success fw-bold">Username</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"><i class='bx bx-user text-success fs-4'></i></i></span>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label text-success fw-bold">Password</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"><i class='bx bx-lock text-success fs-4'></i></span>
